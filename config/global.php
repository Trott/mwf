 ...
 * - header_home_text           Text appearing next to header home button image. (UCSF ONLY)
 * - header_separator           HTML that separates elements in the header, e.g. for breadcrumbs (UCSF ONLY)
 */
