...
class Ucsf_Library_Locations_Missionbay_Menu_Site_Decorator extends Menu_Full_Site_Decorator {
    ...
    public function render() {
        ...
        $this->add_item('<span class="smallprint">Mon - Thurs: 9:00 am - 9:00 pm<br/>Fri: 9:00 am - 5:30 pm<br/>Sat - Sun: CLOSED</span><br/><br/><span class="external">Holidays and exceptions</span>', 'http://library.ucsf.edu/locations/hours?ovrrdr=1', array());
