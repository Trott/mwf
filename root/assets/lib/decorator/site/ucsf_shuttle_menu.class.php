...
class Ucsf_Shuttle_Menu_Site_Decorator extends Menu_Site_Decorator {
    ...
    public function render($raw = false) {
        ...
        $this->add_item('Shuttles By Color', '/shuttle/list/color', array(), $this->_lightning ?  array('data-target-id' => 'il/shuttle/list/color') : array());
        $this->add_item('Shuttles By Location', '/shuttle/list/location', array(), $this->_lightning ? array('data-target-id' => 'il/shuttle/list/location') : array());
